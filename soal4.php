...
<body>
  <h2>Form Pendaftaran Mahasiswa Baru (Versi GET)</h2>
  <form method="get" action="proses-soal4.php">
  ...
  <p><i>Note:</i> Setelah form dikirim, perhatikan bahwa data akan tampil di URL.</p>
</body>
</html>
